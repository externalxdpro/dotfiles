...
- [[#org-mode][Org Mode]]
  ...
  - [[#fix-src-block-indentation][Fix Src Block Indentation]]
  - [[#follow-links-with-enter][Follow Links with Enter]]
  - [[#org-tempo][Org Tempo]]
- [[#popper][Popper]]
...
#+begin_src emacs-lisp
(use-package org
  :hook (org-mode . (lambda () (flycheck-mode -1) (flymake-mode 1))))
#+end_src
