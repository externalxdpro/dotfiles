...
- [[#custom-functions][Custom Functions]]
  ...
  - [[#move-file][Move file]]
  - [[#org-dwim][Org DWIM]]
  - [[#is-there-an-open-frame][Is there an open frame]]
...
** Is there an open frame
#+begin_src emacs-lisp
(defun my/has-gui-frame-p ()
  (seq-some (lambda (f) (display-graphic-p f))
	    (frame-list)))
#+end_src
...
(use-package elcord
  ...
  :init
  (defun my/update-elcord-mode ()
    (if (my/has-gui-frame-p)
	(elcord-mode 1)
      (elcord-mode -1)))
  (add-hook 'after-make-frame-functions (lambda (_frame) (my/update-elcord-mode)))
  (add-hook 'delete-frame-functions (lambda (_frame) (my/update-elcord-mode))))
#+end_src
